  ...
  return (
    <div ref={containerRef} className="relative h-[400vh] bg-[#000]">
      <div className="sticky top-0 h-screen w-full overflow-hidden bg-background">
        ...
        >
          <div className="relative mx-auto flex min-h-screen w-full max-w-md flex-col px-6 pb-40 pt-8 sm:pt-12">
            ...
            <footer className="text-center font-mono text-xs font-bold uppercase tracking-[0.25em] text-muted-foreground/70">Press play. Enter the void.</footer>
          </div>
        </motion.main>
